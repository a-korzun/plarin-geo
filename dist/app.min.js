...
exports.default = new _vuex2.default.Store({
  ...
  actions: {
    updateList: function updateList(context) {
...
exports.default = {
  ...
  computed: {
    ...
    filteredItems: function filteredItems() {
      ...
      var list = this.$store.state.data.map(function (item) {
        var filter = _this.filter.split(',').map(function (el) {
          return el.trim();
        });
        var res = filter.some(function (el) {
          return item.id === el || item.title.toLowerCase().includes(el.toLowerCase());
        });
        var newItem = {
          id: item.id,
          title: item.title
        ...
        if (res && item.id.includes('-')) {
          var params = item.id.split('-');
          newItem = {
            id: params[1],
            title: item.title + (' (' + _this.$store.state.data.find(function (el) {
...
module.exports = __webpack_require__.p + "2ed117f210c172ed5fc1cbb01a6b64ee.png";
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "list"
  }, [(_vm.loading === true) ? _c('div', [_vm._v("loading")]) : _vm._e(), _vm._v(" "), _c('table', {
    staticClass: "table"
  }, [_vm._m(0), _vm._v(" "), _vm._l((_vm.filteredItems || _vm.data), function(item) {
    return _c('tr', {
      key: item.id
    }, [_c('td', {
      staticClass: "ids"
  ...
  return _c('tr', [_c('th', {
    staticClass: "t-head ids"
  }, [_vm._v("ID")]), _vm._v(" "), _c('th', {
    staticClass: "t-head titles"
  }, [_vm._v("Title")])])
}]}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _c('Search'), _vm._v(" "), _c('List')], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Введите ID, набор ID через запятую, название региона или города")])]), _vm._v(" "), _c('button', {
...
module.exports = {
	"data": [
		...
		{
			"id": "152",
			"title": "Великое Герцогство Люксембург"
		},
		{
			"id": "153",
			"title": "Ливия"
		...
		{
			"id": "236",
			"title": "Государство-город Ватикан"
		},
		{
			"id": "237",
			"title": "Болгария"
		...
		{
			"id": "333",
			"title": "Северная Дакота"
		},
		{
			"id": "334",
			"title": "Северная Каролина"
		},
		{
			"id": "335",
			"title": "Теннесси"
		...
		{
			"id": "337",
			"title": "Федеральный округ Колумбия"
		},
		{
			"id": "338",
			"title": "Флорида"
		...
		{
			"id": "393",
			"title": "Новая Шотландия"
		},
		{
			"id": "394",
			"title": "Остров Принца Эдварда"
		},
		{
			"id": "395",
			"title": "Юкон"
		...
		{
			"id": "396",
			"title": "Северо-Западные территории"
		},
		{
			"id": "397",
			"title": "Нунавут"
		...
		{
			"id": "443",
			"title": "Либерецкий край"
		},
		{
			"id": "444",
			"title": "Среднечешский край"
		},
		{
			"id": "445",
			"title": "Устецкий край"
		...
		{
			"id": "448",
			"title": "Карловарский край"
		},
		{
			"id": "449",
			"title": "Пардубицкий край"
		},
		{
			"id": "450",
			"title": "Пльзенский край"
		},
		{
			"id": "451",
			"title": "Оломоуцкий край"
		},
		{
			"id": "452",
			"title": "Моравскосилезский край"
		},
		{
			"id": "453",
			"title": "Злинский край"
		...
		{
			"id": "106-4865",
			"title": "Большая Глушица"
		},
		{
			"id": "106-4866",
			"title": "Большая Черниговка"
		},
		{
			"id": "106-4867",
			"title": "Борское"
		...
		{
			"id": "108-4893",
			"title": "Большие Березники"
		},
		{
			"id": "108-4894",
			"title": "Большое Игнатово"
		},
		{
			"id": "108-4895",
			"title": "Дубенки"
		...
		{
			"id": "134-5276",
			"title": "Старобалтачево"
		},
		{
			"id": "134-5277",
			"title": "Старосубхангулово"
		},
		{
			"id": "134-5278",
			"title": "Стерлибашево"
		...
		{
			"id": "144-5398",
			"title": "Нерчинский Завод"
		},
		{
			"id": "144-5399",
			"title": "Нижний Цасучей"
		},
		{
			"id": "144-5400",
			"title": "Оловянная"
		...
		{
			"id": "18-1000",
			"title": "Владимиро-Александровское"
		},
		{
			"id": "18-1001",
			"title": "Вольно-Надеждинское"
		},
		{
			"id": "18-1002",
			"title": "Дальнегорск"
		...
		{
			"id": "277-6266",
			"title": "Великая Александровка"
		},
		{
			"id": "277-6267",
			"title": "Великая Лепетиха"
		},
		{
			"id": "277-6268",
			"title": "Верхний Рогачик"
		},
		{
			"id": "277-6269",
			"title": "Высокополье"
		...
		{
			"id": "32-1646",
			"title": "Верхнее Дуброво"
		},
		{
			"id": "32-1647",
			"title": "Верх-Нейвинский"
		},
		{
			"id": "32-1648",
			"title": "Верхняя Пышма"
		...
		{
			"id": "370-5659",
			"title": "Петропавловск (Сев.-Каз. обл.)"
		},
		{
			"id": "370-7050",
			"title": "Рузаевка"
		...
		{
			"id": "79-4482",
			"title": "Большое Болдино"
		},
		{
			"id": "79-4483",
			"title": "Большое Мурашкино"
		},
		{
			"id": "79-4484",
			"title": "Варнавино"
